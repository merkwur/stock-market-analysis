...
#                                  line=dict(color='blue', width=1)),
#                       go.Scatter(x=df["Date"],
#                                  y=indicators["rsi"]/ indicators["rsi"].max()+5,
#                                  line=dict(color='blue', width=1)),
...
try:
    ...
    A whole can be understood completely if we understand its parts, and the nature of their sum. In the style of Escher fused with Klimt
